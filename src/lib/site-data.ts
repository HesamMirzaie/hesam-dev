...
export const projects: Project[] = [
  {
    ...
    technologies: ["React", "TypeScript", "TanStack Query", "React Hook Form", "shadcn/ui"],
    status: "Open source",
...
export const education: Education[] = [
  {
    ...
    summary: "Studying machine learning concepts and algorithms while building practical Python skills.",
  },
  {
    period: "2020 - 2024",
    degree: "BSc, Computer Science",
    institution: "Islamic Azad University, Science and Research Branch",
    summary: "Studied graph algorithms, linear algebra, Python, design systems, and SOLID principles.",
  },
]
