...
export function generateStaticParams() { const slugs = getAllPosts().filter((post) => hasPostLanguage(post.slug, "fa")).map((post) => ({ slug: post.slug })); return slugs.length ? slugs : [{ slug: "_missing-persian-post" }] }
