    ...
    case "TypeScript":
      return (
        <svg {...common}>
          ...
          <path d="M8 10h5M10.5 10v7M14 15.8c.7.8 3.4 1.1 3.4-.6 0-2-3.3-1.1-3.3-3.2 0-1.6 2.5-1.8 3.4-.8" />
        </svg>
      );
    case "Next.js":
      return (
        <svg {...common}>
          ...
          <path d="M8.2 16V8l7.7 9.4M15.8 8v6.2" />
        </svg>
      );
    case "Vite":
      return (
        <svg {...common}>
          <path d="m3 5 9 15 9-15-6.7 1.2L12 2 9.7 6.2 3 5Z" />
          <path
            d="m13.2 6-4.1 7h3l-1.3 5 4.2-7h-3l1.2-5Z"
            fill="currentColor"
            stroke="none"
          />
        </svg>
    ...
    case "REST":
      return (
        <svg {...common}>
          ...
          <path d="m7 11 10-3M7 13l10 3" />
        </svg>
      );
    case "WebSocket":
      return (
        <svg {...common}>
          <path d="M4 8.5A8 8 0 0 1 17.5 5L20 7.5M20 7.5h-5M20 7.5v-5M20 15.5A8 8 0 0 1 6.5 19L4 16.5M4 16.5h5M4 16.5v5" />
        </svg>
      );
    case "Docker":
      return (
        <svg {...common}>
          <path d="M3 12h18c-.6 5-4.2 7.5-9 7.5S4.2 17 3 12Z" />
          <path d="M6 9h3v3H6zM9 6h3v3H9zM9 9h3v3H9zM12 9h3v3h-3zM15 9h3v3h-3zM18 8c1.4 0 2.2-.7 2.7-1.5" />
        </svg>
      );
    case "Azure":
      return (
        <svg {...common}>
          <path d="M10.2 3 4 18h5l2.2-4.2h5.5L20 18 13.7 3h-3.5Zm2 4.2 2.7 4.2h-4.8l2.1-4.2Z" />
        </svg>
      );
  }
}
